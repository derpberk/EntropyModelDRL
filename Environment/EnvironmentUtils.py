...
class GroundTruth:
    ...
    def __init__(self, navigation_map, function_type='shekel', dt=1, initial_seed=0):
        ...
        self.num_of_peaks = np.random.RandomState(self.seed).randint(low=1, high=5)
        self.vA = np.random.RandomState(self.seed).random(size=(self.num_of_peaks, 2)) * 2 - 1
    ...
    def sample_gt(self):
        ...
        self.Z = (Z - np.mean(Z))/np.std(Z)  # Normalize Z
